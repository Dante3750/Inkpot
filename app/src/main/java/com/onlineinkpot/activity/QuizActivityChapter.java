...
public class QuizActivityChapter extends AppCompatActivity implements View.OnClickListener {
    ...
    public String timeminute,chapterId,chapterName,f,newvalue,semId,courseIdnew,unitId,name, option1, option2, option3, option4,correctoptionid;
    public long  startTime_second,startTime_minute,startTime_hour=0;
    public int secondnewsnine=0;
    public int secondnews,seconds,count;
   ...
   //public ProgressBar progressBar;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        chapterName = in.getStringExtra("chapterName");
        semId = in.getStringExtra("semId");
        courseIdnew = in.getStringExtra("courseId");
        ...
        if (Cons.isNetworkAvailable(this)) {
            StringRequest courseListRequest = new StringRequest(Request.Method.POST, Cons.URL_SUBJECTQUESTION_LIST,
                    new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {
                            Log.d("responsequizchapter", response.toString());
                            try {
                                jsonObject = new JSONObject(response);
                                jsonarray = jsonObject.getJSONArray("data");
...
//                                progressBar.setVisibility(View.GONE);
    ...
    @Override
    public void onClick(View v) {
        Intent i = new Intent(getApplicationContext(), QuestionActivityChapter.class);
