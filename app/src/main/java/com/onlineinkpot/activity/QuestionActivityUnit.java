...
public class QuestionActivityUnit extends AppCompatActivity {

    private static final String TAG = "QuestionActivitySubject";
    public List<Course> courseList;
    public RadioGroup radiogroup;
    public RadioButton radiobutton1, radiobutton2, radiobutton3, radiobutton4, radioButton;
    public TextView text1, textview2, timertextvalue, totaltimervalue, button, tv_submit_button;
    public String name, option1, option2, option3, option4, timeminutenewsthird, radiobuttonvalue, correctanswer, correctoptionid, timeminute, studentid, semesterid, testid, questionid, subjectid, unitid, chapterid, topicid;
    public JSONObject jsonObject, jsonobject2;
    public JSONArray jsonarray;
    public int a, m = 0, n = 0, count;
    ...
    public String courseId, subjectId, totaltime, unitId, ne, me;
    public Long startTime_second, startTime_minute, startTime_hour;
    String requiredFormat, optionanswer;
...
//        progressBar.setVisibility(View.VISIBLE);
        ...
        countDownTimerNew = new QuestionActivityUnit.MyCountDownTimerNew(l, interval);
...
//                        progressBar.setVisibility(View.VISIBLE);
                    ...
                    if (radiogroup.getCheckedRadioButtonId() != -1) {
                        ...
                        if (radiobuttonvalue.equals(optionanswer)) {
                            n = n + 1;
                            ne = String.valueOf(n);
                            Intent intent = new Intent(QuestionActivityUnit.this, QuizResultActicity.class);
   ...
   /*             studentquestionarrayList.add("0");
                Intent in = new Intent(QuestionActivityUnit.this, QuizResultActicity.class);
            ...
            //  }
            // Toast.makeText(QuestionActivityUnit.this,""+studentquestionarrayList,Toast.LENGTH_SHORT).show();
...
//                        progressBar.setVisibility(View.GONE);
                            ...
                            try {
                                ...
                                name = jsonobject2.getString("question_name");
                                option1 = jsonobject2.getString("option1");
                                option2 = jsonobject2.getString("option2");
                                option3 = jsonobject2.getString("option3");
                                option4 = jsonobject2.getString("option4");
                                correctoptionid = jsonobject2.getString("subjecanswer");
                                correctanswer = "option" + correctoptionid;
                                if (correctoptionid.equals("1")) {
                                    optionanswer = jsonobject2.getString("option1");
                                } else if (correctoptionid.equals("2")) {
                                    optionanswer = jsonobject2.getString("option2");
                                } else if (correctoptionid.equals("3")) {
                                    optionanswer = jsonobject2.getString("option3");
                                } else if (correctoptionid.equals("4")) {
                                    optionanswer = jsonobject2.getString("option4");
                                }
                                studentid = jsonobject2.getString("student_id");
                                subjectid = jsonobject2.getString("subject_id");
                                testid = jsonobject2.getString("q_map_id");
                                questionid = jsonobject2.getString("q_ans_id");
                                semesterid = jsonobject2.getString("semst_id");
                                unitid = jsonobject2.getString("n_unitID");
                                chapterid = jsonobject2.getString("n_chapterID");
                                topicid = jsonobject2.getString("n_topicID");
                                timeminute = jsonobject2.getString("time_minute");
                                ...
                                countDownTimer = new QuestionActivityUnit.MyCountDownTimer(Total_time, interval);
                                if (!timerHasStarted) {
