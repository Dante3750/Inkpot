...
import com.onlineinkpot.adapters.QuizSolutionSecondAdapter;
...
public class QuizSolutionSecondActivity  extends AppCompatActivity {
    ...
    public QuizSolutionSecondAdapter resultnewadapter;
   ...
   /*  for(String s:arr)
    ...
    public void showSQliteDbData() {
        ...
        resultnewadapter = new QuizSolutionSecondAdapter(QuizSolutionSecondActivity.this,
                StudentID_ArrayList,
                ID_ArrayList,
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent in = new Intent(QuizSolutionSecondActivity.this, MainActivity.class);
        startActivity(in);
        delete(studentid);
    }
    }
