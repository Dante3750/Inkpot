...
public class QuizActivityUnit extends AppCompatActivity implements View.OnClickListener {
    ...
    public int seconds;
    public String attemptquestion, percentage, totalcorrect, unitid, timeminute, f, newvalue, name, option1, option2, option3, option4, correctoptionid;                       ;
    public long Total_time = 0;
    public String secondnewsforth = "00:00:00";
    public int secondnewsnine = 0, secondnews;
...
/*    public ProgressBar progressBar;*/
   ...
   String countnew;
    ...
    @Override
    public void onClick(View v) {
        Intent in = new Intent(QuizActivityUnit.this, QuestionActivityUnit.class);
