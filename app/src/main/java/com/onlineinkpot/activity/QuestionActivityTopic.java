...
public class QuestionActivityTopic extends AppCompatActivity {
    ...
    public TextView text1, textview2, timertextvalue, button, totaltimervalue, tv_submit_button;
    ...
    public String timeminute, studentid, semesterid, testid, questionid, subjectid, unitid, chapterid, topicid;
    ...
    public String courseId, subjectId, totaltime, topicId, requiredFormat, optionanswer, ne, me;
...
// progressBar.setVisibility(View.VISIBLE);
        ...
        Intent in = getIntent();
        topicId = in.getStringExtra("topicId");
        ...
        countDownTimerNew = new QuestionActivityTopic.MyCountDownTimerNew(l, interval);
            ...
            public void onClick(View v) {
                ...
                if (i < jsonarray.length()) {
                    ...
                    if (radiogroup.getCheckedRadioButtonId() != -1) {
                        ...
                        hitApiSecond();
                        hitApiForServer();
                        studentquestionarrayList.add("" + radiobuttonvalue);
                        ...
                        if (radiobuttonvalue.equals(optionanswer)) {
                            n = n + 1;
                            ne = String.valueOf(n);
                            Intent intent = new Intent(QuestionActivityTopic.this, QuizResultActicity.class);
    ...
    public class MyCountDownTimerNew extends CountDownTimer {
        ...
        public void onTick(long millisUntilFinished) {
            ...
            if (totalnewvalue.equals("00:00:01")) {
                Intent in = new Intent(QuestionActivityTopic.this, QuizResultActicity.class);
...
//                        progressBar.setVisibility(View.GONE);
                            ...
                            if (timerHasStarted) {
                                ...
                                countDownTimer = new QuestionActivityTopic.MyCountDownTimer(Total_time, interval);
                                if (!timerHasStarted) {
