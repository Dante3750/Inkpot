...
public class QuestionActivityChapter extends AppCompatActivity {
    ...
    public TextView text1, textview2, button, timertextvalue, totaltimervalue, tv_submit_button;
    public String name, option1, option2, option3, option4, optionanswer, requiredFormat;
    ...
    public int secondnews,seconds;
    public String timeminutenew = "";
    public String timeminutenewsthird, radiobuttonvalue, correctanswer, correctoptionid;
    private Handler handler = new Handler();
    private Runnable runnable;
    private long milliSeconds = 0;
    public ArrayList<String> studentquestionarrayList, correctanswerarrayList;
    public String timeminute, studentid, semesterid, testid, questionid, subjectid, unitid, chapterid, topicid, courseId, subjectId, totaltime, chapterId;
    ...
    int positionforth;
    String f,newvalue,value,timenew;
    long l;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       countDownTimerNew = new QuestionActivityChapter.MyCountDownTimerNew(l, interval);
            ...
            public void onClick(View v) {
                ...
                if (i < jsonarray.length()) {
                    if (radiogroup.getCheckedRadioButtonId() != -1) {
                        ...
                        Log.d("timerbutton",timerList.toString());
                        Log.d("i",String.valueOf(i));
                        value = text1.getText().toString();

                     //   Toast.makeText(QuestionActivityChapter.this, "value"+value, Toast.LENGTH_SHORT).show();
                    ...
                    if (radiogroup.getCheckedRadioButtonId() != -1) {
                        ...
                        if (radiobuttonvalue.equals(optionanswer)) {
                            n = n + 1;
                            ne = String.valueOf(n);
                            Intent intent = new Intent(QuestionActivityChapter.this, QuizResultActicity.class);
    ...
    public class MyCountDownTimerNew extends CountDownTimer {
        ...
        public void onFinish() {
           ...
           // Toast.makeText(QuestionActivityChapter.this, "arraylist"+studentquestionarrayList, Toast.LENGTH_SHORT).show();
        }
        ...
        public void onTick(long millisUntilFinished) {
            ...
            if (totalnewvalue.equals("00:00:00")) {
                Intent in = new Intent(QuestionActivityChapter.this, QuizResultActicity.class);
    ...
    public class MyCountDownTimer extends CountDownTimer {
        ...
        public void onFinish() {
           ...
           // Toast.makeText(QuestionActivityChapter.this, ""+studentquestionarrayList, Toast.LENGTH_SHORT).show();
         }
        ...
        if (Cons.isNetworkAvailable(this)) {
            ...
            StringRequest courseListRequest = new StringRequest(Request.Method.POST, Cons.URL_SUBJECTQUESTION_LIST,
                    new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {
                            Log.d("responsequestion", response.toString());
                            ...
                            try {
                                ...
                                secondforth = secondnewsnine % SECONDS_IN_A_MINUTE;
                                int totalMinutes = secondnewsnine / SECONDS_IN_A_MINUTE;
                                int minutes = totalMinutes % MINUTES_IN_AN_HOUR;
                                int hours = totalMinutes / MINUTES_IN_AN_HOUR;
                                f = hours + ":" + minutes + ":" + secondforth;
                                ...
                                startTime_hour = 3600 * (Long.parseLong(string1));
                                 Total_timernewvalue = (startTime_second + startTime_minute + startTime_hour) * 1000;
                                Log.d("hh", newvalue);
                                Log.d("totaltimevalue", String.valueOf(Total_timernewvalue));

                                //second.setText("" + newvalue);

                                   countDownTimerNew = new QuestionActivityChapter.MyCountDownTimerNew(Total_timernewvalue, interval);
                                    countDownTimerNew.start();*/
                      ...
                      //String[] parts = timeminute.split(":", 3);
                                ...
                                countDownTimer = new QuestionActivityChapter.MyCountDownTimer(Total_time, interval);
                ...
                protected Map<String, String> getParams() {
                    ...
                    params.put("type", "chapter");
                    params.put("helpId", chapterId);
                    return params;
                }
            };
...
//                        progressBar.setVisibility(View.GONE);
                            linearlayout.setVisibility(View.VISIBLE);
                            Log.d("responsequestionsecond", response.toString());
                            try {
                                jsonObject = new JSONObject(response);
                                jsonarray = jsonObject.getJSONArray("data");
                                JSONObject object = jsonarray.getJSONObject(i);
