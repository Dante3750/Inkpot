...
import com.onlineinkpot.activity.QuizActivitySubject;
import com.onlineinkpot.adapters.FragmentMCQAdapter;
...
public class MCQFragment extends Fragment {
    ...
    //    List<String> data;
    private FragmentMCQAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_mcq, null, false);
    ...
    private void initializeLayoutContents(View view) {
        ...
        rv_course = (RecyclerView) view.findViewById(R.id.rv_mcq);
        mAdapter = new FragmentMCQAdapter(getContext(), courseList);
        ...
        rv_course.addOnItemTouchListener(new Cons.RecyclerTouchListener(getContext(), rv_course, new Cons.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent i = new Intent(getActivity(), QuizActivitySubject.class);
                Bundle bundle1 = ActivityOptions.makeCustomAnimation(getActivity(), R.anim.push_left_in, R.anim.push_left_out).toBundle();
                i.putExtra("subjectId", myCourse.getMySubject_id());
                i.putExtra("courseIdNew", myCourse.getMyCourse_id());
                i.putExtra("semesterId", myCourse.getMySemester_id());
