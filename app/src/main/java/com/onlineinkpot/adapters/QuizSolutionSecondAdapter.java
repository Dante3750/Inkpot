...
/**
 * Created by Akhil on 10/23/2017.
 */

public class QuizSolutionSecondAdapter extends RecyclerView.Adapter<QuizSolutionAdapter.MyViewHolder> {
    ...
    public QuizSolutionSecondAdapter(Context context, List<Course> courseList) {
    ...
    @Override
    public QuizSolutionAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_quiz_solution, parent, false);
        return new QuizSolutionAdapter.MyViewHolder(itemView);
    }


    @Override
    public void onBindViewHolder(final QuizSolutionAdapter.MyViewHolder holder, int position) {
